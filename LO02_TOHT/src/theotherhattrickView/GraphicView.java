		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(player1, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
					.addGap(25)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(middleCards, GroupLayout.DEFAULT_SIZE, 550, Short.MAX_VALUE)
							.addGap(25))
						.addComponent(player2, GroupLayout.PREFERRED_SIZE, 549, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(player3, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE))
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(lblTourActuel, GroupLayout.PREFERRED_SIZE, 250, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(infos, GroupLayout.PREFERRED_SIZE, 500, GroupLayout.PREFERRED_SIZE)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(player3, GroupLayout.PREFERRED_SIZE, 500, GroupLayout.PREFERRED_SIZE)
								.addComponent(player1, GroupLayout.PREFERRED_SIZE, 500, GroupLayout.PREFERRED_SIZE))
							.addGap(206))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(473)
							.addComponent(player2, GroupLayout.PREFERRED_SIZE, 223, Short.MAX_VALUE)
							.addGap(10))))
				.addGroup(groupLayout.createSequentialGroup()
					.addGap(60)
					.addComponent(middleCards, GroupLayout.PREFERRED_SIZE, 238, Short.MAX_VALUE)
					.addGap(242))
		);
			...
			gl_player1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_player1.createSequentialGroup()
					...
					.addGroup(gl_player1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_player1.createSequentialGroup()
							.addComponent(p1prop1, GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(gl_player1.createSequentialGroup()
		...
		gl_player1.setVerticalGroup(
			gl_player1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_player1.createSequentialGroup()
					.addComponent(p1Name)
					.addGap(40)
					.addComponent(p1prop1, GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
